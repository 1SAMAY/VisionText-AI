import { Github, ScanLine, Sparkles } from 'lucide-react'

export default function Navbar() {
  return (
    <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-5 sm:px-6 lg:px-8">
      <div className="flex items-center gap-3">
        <div className="grid h-11 w-11 place-items-center rounded-lg border border-cyan-200/30 bg-cyan-300/10 shadow-neon">
          <ScanLine className="h-5 w-5 text-ion" aria-hidden="true" />
        </div>
        <div>
          <p className="text-base font-semibold tracking-wide text-white">VisionText AI</p>
          <p className="text-xs text-cyan-100/65">Browser OCR studio</p>
        </div>
      </div>
